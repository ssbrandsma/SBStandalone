...
-- Offline ISO 3166-1 alpha-2 catalog, sorted by display name.
local countries = {
	...
	{ code = "AG", name = "Antigua & Barbuda" }, { code = "AR", name = "Argentina" }, { code = "AM", name = "Armenia" },
	...
	{ code = "BA", name = "Bosnia & Herzegovina" }, { code = "BW", name = "Botswana" }, { code = "BV", name = "Bouvet Island" },
	...
	{ code = "CA", name = "Canada" }, { code = "CV", name = "Cape Verde" }, { code = "BQ", name = "Caribbean Netherlands" },
	...
	{ code = "CG", name = "Congo - Brazzaville" }, { code = "CD", name = "Congo - Kinshasa" }, { code = "CK", name = "Cook Islands" },
	{ code = "CR", name = "Costa Rica" }, { code = "CI", name = "Cote d'Ivoire" }, { code = "HR", name = "Croatia" },
	{ code = "CU", name = "Cuba" }, { code = "CW", name = "Curacao" }, { code = "CY", name = "Cyprus" },
	...
	{ code = "GY", name = "Guyana" }, { code = "HT", name = "Haiti" }, { code = "HM", name = "Heard & McDonald Islands" },
	{ code = "HN", name = "Honduras" }, { code = "HK", name = "Hong Kong SAR China" }, { code = "HU", name = "Hungary" },
	...
	{ code = "MO", name = "Macao SAR China" }, { code = "MG", name = "Madagascar" }, { code = "MW", name = "Malawi" },
	...
	{ code = "PW", name = "Palau" }, { code = "PS", name = "Palestinian Territories" }, { code = "PA", name = "Panama" },
	...
	{ code = "RE", name = "Reunion" }, { code = "RO", name = "Romania" }, { code = "RU", name = "Russia" },
	...
	{ code = "ZA", name = "South Africa" }, { code = "GS", name = "South Georgia & South Sandwich Islands" }, { code = "KR", name = "South Korea" },
	{ code = "SS", name = "South Sudan" }, { code = "ES", name = "Spain" }, { code = "LK", name = "Sri Lanka" },
	{ code = "BL", name = "St. Barthelemy" }, { code = "SH", name = "St. Helena" }, { code = "KN", name = "St. Kitts & Nevis" },
	{ code = "LC", name = "St. Lucia" }, { code = "MF", name = "St. Martin" }, { code = "PM", name = "St. Pierre & Miquelon" },
	{ code = "VC", name = "St. Vincent & Grenadines" }, { code = "SD", name = "Sudan" }, { code = "SR", name = "Suriname" },
	...
	{ code = "UM", name = "U.S. Outlying Islands" }, { code = "VI", name = "U.S. Virgin Islands" }, { code = "UG", name = "Uganda" },
	{ code = "UA", name = "Ukraine" }, { code = "AE", name = "United Arab Emirates" }, { code = "GB", name = "United Kingdom" },
	{ code = "US", name = "United States" }, { code = "UY", name = "Uruguay" }, { code = "UZ", name = "Uzbekistan" },
	{ code = "VU", name = "Vanuatu" }, { code = "VA", name = "Vatican City" }, { code = "VE", name = "Venezuela" },
	{ code = "VN", name = "Vietnam" }, { code = "WF", name = "Wallis & Futuna" }, { code = "EH", name = "Western Sahara" },
	{ code = "YE", name = "Yemen" }, { code = "ZM", name = "Zambia" }, { code = "ZW", name = "Zimbabwe" },
}

local byCode = {}
for _, country in ipairs(countries) do byCode[country.code] = country end

function all() return countries end

function get(code)
	return type(code) == "string" and byCode[string.upper(code)] or nil
end

function validCode(code) return get(code) ~= nil end

function displayName(code)
	local country = get(code)
	return country and country.name or tostring(code or "")
end
